  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-slate-100 text-gray-950 relative`}>
          ...
          <div className="bg-[#dbd7fb] absolute top-[-1rem] left-[-35rem] -z-10 h-[31.25rem] w-[50rem] rounded-full blur-[13rem] sm:left-[-36rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
          {children}
      </body>
    </html>
  );
